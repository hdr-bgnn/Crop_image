...
## 1 - Short description
  ...
  + The metadata json file contained the bounding box of the fish which use to crop the fish [here is an example](Test_data/INHS_FISH_000742_cropped.jpg). We increase the size of the bounding box around the fish by 5% increase (by default, parameter) in case the bounding box (from the metadata) would cut the edge of the fish.
